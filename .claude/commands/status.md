...
9. Готовность: есть ли `book/_master/SCORECARD.md` (дата, вердикт
   green/yellow/red). `/status` — описательный отчёт; за вердиктом и KPI
   отсылай к `/audit` (не дублируй его подсчёты здесь).
